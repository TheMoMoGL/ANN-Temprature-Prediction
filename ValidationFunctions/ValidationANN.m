...
for iteration = 1:length(target)
target = Reverse_normalisation(target(:,iteration), maxValues, minValues);
output = Reverse_normalisation(output(:,iteration), maxValues, minValues);
